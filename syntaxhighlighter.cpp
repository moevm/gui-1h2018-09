...
string SyntaxHighlighter::parseline(string &line)
{
    string stringToReturn = line;
        ...
        if ((stringToReturn.empty() == false) && !(std::regex_search(stringToReturn, match, bold_regex) || std::regex_search(stringToReturn, match, italic_regex)
        ...
        std:: cout<< stringToReturn;
        return stringToReturn;

}

void SyntaxHighlighter::str_replace(string &s, string &search, string &replace)
{
...
bool SyntaxHighlighter::search_headers_style(string &stringToReturn, std::smatch &match)
{
